...
public class DashBoardEarnFragment extends Fragment implements DashBoardAdapterInterface {
    private static final String TAG = DashBoardSpentFragment.class.getSimpleName();
    ...
    public DashBoardEarnFragment(){

    }

    public static DashBoardEarnFragment newInstance(String param1, String param2) {
        DashBoardEarnFragment fragment = new DashBoardEarnFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dashboard_earn, container, false);
        init(view);
        return view;
    }
    ...
    public void dashBoardUIData() {
        new Thread(() -> {
            String dayCountTotalHeadText = Utils.getFormattedNumber(db.getTotalMoneyInCurrentDay(GlobalConstants.TYPE_EARN));
            String monthCountTotalHeadText = Utils.getFormattedNumber(db.getTotalMoneyInCurrentMonth(GlobalConstants.TYPE_EARN));
            String yearCountTotalHeadText = Utils.getFormattedNumber(db.getTotalMoneyInCurrentYear(GlobalConstants.TYPE_EARN));
            dbr = db.getDashBoardRecords(GlobalConstants.TYPE_EARN);
    ...
    public void viewOnClick(String dataText) {
        ...
        intent.putExtra(GlobalConstants.CATEGORY_TYPE,GlobalConstants.TYPE_EARN);
