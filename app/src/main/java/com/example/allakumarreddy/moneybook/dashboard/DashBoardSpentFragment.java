...
public class DashBoardSpentFragment extends Fragment implements DashBoardAdapterInterface {
    ...
    public DashBoardSpentFragment() {

    }

    public static DashBoardSpentFragment newInstance(String param1, String param2) {
        DashBoardSpentFragment fragment = new DashBoardSpentFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dashboard_spent, container, false);
        init(view);
        return view;
    }
    ...
    public void dashBoardUIData() {
        new Thread(() -> {
            ...
            dbr = db.getDashBoardRecords(GlobalConstants.TYPE_SPENT);
    ...
    public void viewOnClick(String dataText) {
        ...
        intent.putExtra(GlobalConstants.CATEGORY_TYPE, GlobalConstants.TYPE_SPENT);
