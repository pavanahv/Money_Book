...
public class DashBoardDueFragment extends Fragment implements DashBoardAdapterInterface {
    ...
    public DashBoardDueFragment(){

    }

    public static DashBoardDueFragment newInstance(String param1, String param2) {
        DashBoardDueFragment fragment = new DashBoardDueFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dashboard_due, container, false);
        init(view);
        return view;
    }
    ...
    public void dashBoardUIData() {
        new Thread(() -> {
            String dayCountTotalHeadText = Utils.getFormattedNumber(db.getTotalMoneyInCurrentDay(GlobalConstants.TYPE_DUE));
            String monthCountTotalHeadText = Utils.getFormattedNumber(db.getTotalMoneyInCurrentMonth(GlobalConstants.TYPE_DUE));
            String yearCountTotalHeadText = Utils.getFormattedNumber(db.getTotalMoneyInCurrentYear(GlobalConstants.TYPE_DUE));
            dbr = db.getDashBoardRecords(GlobalConstants.TYPE_DUE);
    ...
    public void viewOnClick(String dataText) {
        ...
        intent.putExtra(GlobalConstants.CATEGORY_TYPE,GlobalConstants.TYPE_DUE);
