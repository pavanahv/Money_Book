...
public class HomeSpentFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MyAdapter(mbr, getContext(), GlobalConstants.TYPE_SPENT, mHomeAdapterInterface);
    }
    ...
    public void updataUI() {
        new Thread(() -> {
            mbr = mDbHandler.getRecords(curDateStr, GlobalConstants.TYPE_SPENT);
