...
public class HomeEarnFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MyAdapter(mbr, getContext(), GlobalConstants.TYPE_EARN, mHomeAdapterInterface);
    }
    ...
    public void updataUI(){
        new Thread(() -> {
            mbr = mDbHandler.getRecords(curDateStr, GlobalConstants.TYPE_EARN);
