...
public class DriveServiceHelper {
    ...
    public Task<String> createFile() {
        return Tasks.call(mExecutor, () -> {
            File metadata = new File()
                    ...
                    .setName(GlobalConstants.GOOGLE_DRIVE_BACKUP_FILE_NAME);
     ...
     * content}.
     */
    public Task<Void> saveFile(String fileId, String name, String content, MediaHttpUploaderProgressListener uploadProgressCallback) {
        return Tasks.call(mExecutor, () -> {
